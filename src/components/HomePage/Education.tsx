...
const educationInfo: EducationType[] = [
  ...
  },
  {
    ...
    date: "October 2025",
    grade: 15,
    skillsList: ["Unity/C#", "Work in groups of 8 people", "Voice Command and Hand-Tracking"],
  },
  ...
  return (
    <>
      <div className="container-fluid" id="education">
        ...
        <div className="row justify-content-around align-items-start" id="EducationCards">
          {educationInfo.map((info, index) => (
            <EducationCard key={index} {...info} isExpanded={expandedIndex === index} onToggle={() => handleToggle(index)}/>
          ))}
        </div>
      </div>
    </>
